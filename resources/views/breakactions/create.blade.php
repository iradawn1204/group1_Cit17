                ...
                <div class="container">
                   <br><br>
                    <center><h1>Add</h1></center>
                       ...
                       <form action="/shotgun/breakactions" method="POST">   
                       @csrf     
                                             @if ($errors->any())
                           ...
                           <form class="col s12">
                             <div class="row">
                                 ...
                                 Description:</p>
                                     ...
                                     <p>Barell Type:</p>
                                     <input placeholder="" id="barrel_type" type="text" name="barrel_type">
                                     <p>Double Barell Type:</p>
                                     <input required placeholder=""  id="double_barrel_type" type="text" name="double_barrel_type">
                                     <p>Bullet:</p>
                                    ...
                                    <div class="users_feedback">
                                     ...
                                     <p>User Rating:</p>
                                     <input required placeholder=""  id="user_rating" type="text" name="user_rating">
                                     <p>User Comment:</p>
